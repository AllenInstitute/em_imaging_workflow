...
RENDER_STACK_DOWNSAMPLED = 'em_2d_montage_downsample_0_01'
RENDER_STACK_DOWNSAMPLED_MAPPED = 'em_2d_montage_downsample_0_01_mapped'
...
def get_workflow_node_input_template(task, name=None):
