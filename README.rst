em_imaging_workflow
##############
Blue Sky (https://github.com/AllenInstitute/blue_sky_workflow_engine) workflow to support continuous processing and assembly of electron microscopy image volumes.
